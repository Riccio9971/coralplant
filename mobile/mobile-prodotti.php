...
if ($filtro_varieta > 0) {
    ...
    // Ordina mettendo le immagini principali per prime
    $base_query .= " ORDER BY fp.is_principale DESC, fp.titolo";
    ...
    $base_query .= " ORDER BY s.nome, v.nome, fp.is_principale DESC, fp.titolo";
} else {
    ...
    if ($filtro_specie > 0) {
        ...
        $base_query = "
            ...
            ORDER BY s.nome, v.nome, fp.titolo";
    }
}
